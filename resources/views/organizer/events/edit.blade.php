        ...
        <form action="{{ route('organizer.events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-6">
                    ...
                    <select name="category" id="category"
                        ...
                        <option value="culiner" {{ old('category', $event->category) == 'culiner' ? 'selected' : '' }}>Culinary</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="ticket_quota" id="ticket_quota" value="{{ old('ticket_quota', $event->ticket_quota) }}"
                        class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-yellow-500 focus:ring-yellow-500"
                        min="1" required>
                    @error('ticket_quota')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
