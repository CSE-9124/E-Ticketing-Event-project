<nav class="bg-blue-950 w-[14rem] h-auto flex flex-col gap-10 z-40">
    <!-- Logo -->
            ...
            @if (auth()->user()->role === 'admin')
                ...
                <li>
                    <a href="{{ route('admin.dashboard') }}"
                        class="block px-4 py-2.5 text-slate-200 font-semibold hover:bg-blue-700 hover:text-white rounded-lg">
                        Dashboard
                    </a>
                </li>
                <li>
